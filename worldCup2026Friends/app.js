...
const displayLaws = {
  ...
  qf: "ربع النهائي يعمل بنفس نظام دور الـ 8: رصيد اللاعب قبل الدور يقسم على 4 مباريات، وداخل كل مباراة 90% للفريق المتوقع فوزه و10% للفريق الآخر. حصة الخسارة للتوقع الصحيح تُلغى، ونقاط التوقعات الخاطئة فقط توزع على أصحاب التوقع الصحيح بعد اعتماد النتيجة. الجوكر متاح في هذا الدور لمباراة واحدة فقط.",
