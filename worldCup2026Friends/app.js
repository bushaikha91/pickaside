...
const laws = {
  ...
  r8: "رصيد كل مشارك قبل الدور ينقسم على 4 مباريات. في كل مباراة 80% من حصة المباراة للفائز و20% للترشيح الأقل، ونقاط الخسارة تتوزع على أصحاب التوقع الصحيح.",
  qf: "ربع النهائي يعمل بنفس نظام دور الـ 8: الرصيد ينقسم على 4 مباريات، 80% للفائز و20% للترشيح الأقل، مع توزيع خسائر التوقعات الخاطئة على الفائزين.",
...
const displayLaws = {
  ...
  r8: "رصيد كل مشارك قبل بداية الدور يقسم على 4 مباريات. في كل مباراة يذهب 80% من حصة المباراة للفريق الذي تتوقع فوزه، و20% للفريق الآخر. إذا كان توقعك صحيحاً تحصل على حصة الـ 80% وتُلغى حصة الـ 20% ولا تدخل في بول الخسارة. نقاط التوقعات الخاطئة فقط تجمع وتوزع بالتساوي على أصحاب التوقع الصحيح في نفس المباراة.",
  qf: "ربع النهائي يعمل بنفس نظام دور الـ 8: رصيد اللاعب قبل الدور يقسم على 4 مباريات، وداخل كل مباراة 80% للفريق المتوقع فوزه و20% للفريق الآخر. حصة الخسارة للتوقع الصحيح تُلغى، ونقاط التوقعات الخاطئة فقط توزع على أصحاب التوقع الصحيح بعد اعتماد النتيجة. الجوكر متاح في هذا الدور لمباراة واحدة فقط.",
